...
# --- ENDPOINT MỚI CHO TOP PRODUCTS ---
@app.websocket("/ws/top_products")
async def websocket_top_products(websocket: WebSocket):
    await websocket.accept()
    consumer = KafkaConsumer(
        'top_products',
        bootstrap_servers=[KAFKA_BROKER],
    ...
    try:
        ...
        print(f"Connection top_products closed: {e}")
